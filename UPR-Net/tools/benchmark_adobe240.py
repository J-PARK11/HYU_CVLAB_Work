...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='benchmark on adobe240fps')

    #**********************************************************#
    # => args for dataset and data loader
    parser.add_argument('--data_root', type=str, required=True,
            help='root dir of adobe240fps dataset')
    ...
    print("benchmarking on adobe240fps...")
    print('\n>>>>>>>>>>>>>>>>>> Evaluation <<<<<<<<<<<<<<<<<<')
