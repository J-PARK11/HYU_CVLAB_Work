...
def FLAGS():
    ...
    parser.add_argument("--clip_distance", type=float, default=1000.0)
    parser.add_argument("--output_folder", type=str, default=None)
    parser.add_argument("--down_scale_factor", type=float, default=1.0)
    parser.add_argument("--reg_factor", type=float, default=5.70378)
...
if __name__ == "__main__":
    ...
    print('pred folder:',flags.predictions_dataset)
    print('gt folder:',flags.target_dataset)
    ...
    print("\ntotal metrics:")
    print(metrics)
    print((np.sum(np.array(metrics2), 0) / len(metrics2)).round(4))
    print('\n>>>>>>>>>>>>>>>> Complete <<<<<<<<<<<<<<<<')
